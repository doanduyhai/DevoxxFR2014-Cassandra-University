...
public class MainController {
    ...
    @ResponseBody
    public ValueWithTimestamp insertWithCurrentTimePlus(@PathVariable("value") String value,
            @PathVariable("shift") int shiftInSecs) {
    ...
    public String resetDb() {
        dbService.resetDb();
        return "Tables effacées avec succès";
    }
